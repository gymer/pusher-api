...
func init() {
	...
	beego.GlobalControllerRouter["github.com/gymer/pusher-api/controllers:ObjectController"] = append(beego.GlobalControllerRouter["github.com/gymer/pusher-api/controllers:ObjectController"],
